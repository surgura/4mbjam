...
int main()
{
	try
	{
		...
		while (!WindowShouldClose())
		{
			...
			{
				player.Update(
					1.0_f32 / fps, gravity, world, glm::fvec2{mouse_diff.x, mouse_diff.y});
			}
			...
			for (auto const& triangle : world.triangles)
			{
				DrawTriangle3D(
					Vector3{
						world.points[triangle.index1].x,
						world.points[triangle.index1].y,
						world.points[triangle.index1].z},
					Vector3{
						world.points[triangle.index2].x,
						world.points[triangle.index2].y,
						world.points[triangle.index2].z},
					Vector3{
						world.points[triangle.index3].x,
						world.points[triangle.index3].y,
						world.points[triangle.index3].z},
					Color{255, 0, 0, 255});
			...
			{
				DrawText(
					"ESC to start/pause", GetScreenWidth() / 2, GetScreenHeight() / 2, 30, BLACK);
			}
